...
def load_wavelength_array():
    ...
    wav_fname =  pkg_resources.resource_filename('cclya_payne', 'data/'+'cclya_wavelength.npz') # os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_wavelength.npz')  #os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_wavelength.npz')
...
def load_training_data():
    ...
    training_fname =  pkg_resources.resource_filename('cclya_payne', 'data/'+'cclya_training_spectra.npz') # os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_training_spectra.npz')  #os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_training_spectra.npz')
    validation_fname =  pkg_resources.resource_filename('cclya_payne', 'data/'+'cclya_validation_spectra.npz') # os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_validation_spectra.npz')  #os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_validation_spectra.npz')
...
def get_loss():
    ...
    loss_fname = pkg_resources.resource_filename('cclya_payne', 'data/'+'cclya_training_loss.npz') # os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_training_loss.npz') # os.path.join(os.path.dirname(os.path.realpath(__file__)),'data/cclya_training_loss.npz')
